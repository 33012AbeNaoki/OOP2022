...
namespace DataBaseSample {
    public partial class Form1 : Form {
        ...
        private void btConnect_Click(object sender, EventArgs e) {
            ...
            // TODO: このコード行はデータを 'infosys202202DataSet.社員' テーブルに読み込みます。
            // 必要に応じて移動、または削除をしてください。
            this.社員TableAdapter.Fill(this.infosys202202DataSet.社員);
        }
        ...
        private void btExcute_Click(object sender, EventArgs e) {
            ...
            this.社員TableAdapter.FillBySalary(this.infosys202202DataSet.社員, int.Parse( tbValue.Text));
        }
    }
}
